 ...
 * This is REQUIRED for Supabase SSR auth to work correctly
 * with Next.js App Router.
 *
 * Without this middleware, user sessions will expire silently
 * and your server components will see an unauthenticated user.
 */
export async function updateSession(request: NextRequest) {
  ...
  // to revalidate the Auth token. getSession() reads from local
